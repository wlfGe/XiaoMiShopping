	...
	<body>
		...
		<div id="all">
			...
			<div id="top">
				...
				<div id="top2"></div>
				<div id="top3">
					<span>欢迎您，${adminName}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="">退出系统</a>
				</div>
			</div>
			<!--下部分-->
			<div id="bottom">
				...
				<div id="bleft">
					...
					<div id="lbottom">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/admin/prodtype.jsp" target="myright">
								<li class="one"><span class="glyphicon glyphicon-sort" style="color: white;"></span>&nbsp;&nbsp;&nbsp;&nbsp;类型管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-play" style="color: white;"></span> </li>
							</a>
